...
// rebases(where: {contract: "0xd46Cf59668880fd478Ef5eAe05DcA3B96CE6416B"}, orderBy: timestamp, first: 1000, orderDirection: desc) {
...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all PHM staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing PHM.",
  ...
  holder: "Holders, represents the total number of Phmies (sPHM holders)",
  staked: "PHM Staked, is the ratio of sPHM to PHM (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sPHM emissions can be sustained at a given rate. Lower APY = longer runway",
};
